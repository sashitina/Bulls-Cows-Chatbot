...
theme: /
    ...
    state: Правила
        ...
        script:
            $session = {}
        a: Сыграем в "Быки и коровы". Я загадаю 4-значное число с неповторяющимися цифрами, ты попытаешься отгадать. Каждая угаданная цифра - это "корова". Цифра, угаданная вплоть до позиции - "бык". <br><br> Например, я загадал число «3219». <br><br> Твое число: «2310». <br><br> Результат: один «бык» и две «коровы».
        a: Начнем?
        go!: /Правила/Согласен?
